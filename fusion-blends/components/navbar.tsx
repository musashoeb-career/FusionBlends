...
export default function NavBar() {
    return(
        <div className="flex">
            ...
            <div className="relative rounded-lg w-[150px] h-[155px] m-[15px] p-[20px] bg-white">
                <Image src = {"/fusion-logo.png"} alt = "Fusion Blends Logo" objectFit="contain" layout="fill"></Image>
            </div>
           <nav className="flex-6 flex justify-around items-center mt-[20px] text-white">
           ...
           <div className="flex-1 flex justify-around items-center mt-[20px] w-1/8"> 
